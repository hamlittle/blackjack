...
const WEIGHTS: [Weights; 11] = [
    ...
    Weights { lr: 5.0e-5, gamma: 0.990, eps: 0.80 },
    ...
    Weights { lr: 1.0e-7, gamma: 0.995, eps: 0.05 },
    Weights { lr: 5.0e-8, gamma: 0.995, eps: 0.05 },

    Weights { lr: 1.0e-8, gamma: 1.000, eps: 0.05 },
];

#[rustfmt::skip]
const HYPER: [Hyper; 11] = [
    Hyper { weights: WEIGHTS[0],  iterations:    50_000, replay:  25_000, batch_size: 128, gen_steps: 4, train_steps: 1, trunc: 52 },
    Hyper { weights: WEIGHTS[1],  iterations:    50_000, replay:  25_000, batch_size: 128, gen_steps: 4, train_steps: 1, trunc: 52 },
    Hyper { weights: WEIGHTS[2],  iterations:   100_000, replay:  25_000, batch_size: 128, gen_steps: 4, train_steps: 2, trunc: 52 },
    Hyper { weights: WEIGHTS[3],  iterations:   100_000, replay:  25_000, batch_size: 128, gen_steps: 4, train_steps: 2, trunc: 52 },
    ...
    Hyper { weights: WEIGHTS[10], iterations: 2_000_000, replay:  200_000, batch_size: 512, gen_steps: 4, train_steps: 4, trunc: 52 },
];
